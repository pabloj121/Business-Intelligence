...
lgbm = lgb.LGBMClassifier(objective='regresion_l1', num_leaves = 70, n_estimators=500,n_jobs=-1) #boosting_type= 'rf', 
lgbm, y_test_lgbm = validacion_cruzada(lgbm,X_samp,y_samp,skf)
...
'''
------ LightGBM...
F1 score (val): 0.7986, tiempo: 199.81 segundos
F1 score (val): 0.7972, tiempo: 108.40 segundos
F1 score (val): 0.7966, tiempo: 109.71 segundos
F1 score (val): 0.7981, tiempo:  91.78 segundos
F1 score (val): 0.7977, tiempo:  42.19 segundos
