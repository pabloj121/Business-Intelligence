...
#RandomForestClassifier(n_estimators = 500, class_weight={1:6.5,2:1.5,3:2}, n_jobs=6
...
feat_selector = BorutaPy(rf, max_iter=9, n_estimators=200,  random_state=123456) #verbose=0,
...
print("\n------ Ruido-----\n")
oversampler = sv.SMOTE_IPF(proportion=1.0, n_jobs = -1, random_state=123456)
X_samp, y_samp = oversampler.sample(X_filtered, y)
...
#rf = RandomForestClassifier(n_estimators = 500, class_weight={1:6.5,2:1.5,3:2}, n_jobs=-1 )
